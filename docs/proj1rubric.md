...
|-----|--------|---------|
|workload is spread over the whole team (one team member is often Xtimes more productive than the others...but nevertheless, here is a track record that everyone is contributing a lot)|3|Evidence in GH  (https://github.com/het-patel99/cheapBuy/graphs/contributors)|
| Number of commits|3|In GH (https://github.com/het-patel99/cheapBuy/commits/main)|
| Number of commits: by different people|3| Evidence in GH (https://github.com/het-patel99/cheapBuy/commits/main)|
